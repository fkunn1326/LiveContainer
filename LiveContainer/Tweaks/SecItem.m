...
void SecItemGuestHooksInit(void)  {
    ...
    if(keychainGroupId == 0) {
        accessGroup = [NSString stringWithFormat:@"%@.com.xtool.runner.shared", groupId];
    } else {
        accessGroup = [NSString stringWithFormat:@"%@.com.xtool.runner.shared.%d", groupId, keychainGroupId];
    }
